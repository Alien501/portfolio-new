...
const socialLinks: SocialItem[] = [
    ...
    },
    {
        ...
        link: 'https://www.linkedin.com/in/vignesh501/'
    },
    {
...
const SocialCard = ({ icon, link }: SocialItem) => {
    return (
        <a target='_' role='button' href={link} className="social-card h-[32px] w-[32px] bg-primary-dark/5 p-1 rounded-md outline outline-primary-light/10 hover:shadow-[var(--shadow-inset)] shadow-[var(--shadow-inset--hover)]">
            {icon}
        </a>
    )
}
